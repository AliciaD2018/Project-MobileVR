    ...
    public void Update()
    {
        ...
        if (Physics.Raycast(transform.position, transform.forward, out hit, _maxDistance))
        {
            ...
            if (_gazedAtObject != hit.transform.gameObject)
            {
                ...
                if (hit.transform.name == "startPlaying")
                {
                    _gazedAtObject?.SendMessage("OnPointerExit");
                    _gazedAtObject = hit.transform.gameObject;
                    _gazedAtObject.SendMessage("goToPlay");

                }else if (hit.transform.name == "btnQuit")
                {
                    _gazedAtObject?.SendMessage("OnPointerExit");
                    _gazedAtObject = hit.transform.gameObject;
                    _gazedAtObject.SendMessage("quitMenu");
                ...
                else if (hit.transform.name == "About")
                {
                    _gazedAtObject?.SendMessage("OnPointerExit");
                    _gazedAtObject = hit.transform.gameObject;
                    _gazedAtObject.SendMessage("goToDevelopers");
                ...
                else if (hit.transform.name == "Instructions")
                {
                    _gazedAtObject?.SendMessage("OnPointerExit");
                    _gazedAtObject = hit.transform.gameObject;
                    _gazedAtObject.SendMessage("goToInstructions");
